...
return (
    <div className="flex items-center">
        <img src={image} alt="flag" className="w-12 h-10 rounded-xl mr-2 object-cover transition-transform duration-300 ease-in-out transform hover:scale-110"/>
        <select
            value={SelectedLanguage}
            onChange={handleChangeLanguage}
            className="bg-gray-800/80 text-white rounded-md p-2"
        >
