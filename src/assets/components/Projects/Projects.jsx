  ...
  return (
    <section className="container mx-auto py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <ProjectCard title="Chat" description="BrIAn es un chatbot de inteligencia artificial para Discord diseñado para interactuar en canales de voz y proporcionar respuestas inteligentes en tiempo real y capacidad de pasar musica." imgSrc="/images/chat.png" demoLink="" codeLink="https://github.com/ianbokser/chat.png"/>
